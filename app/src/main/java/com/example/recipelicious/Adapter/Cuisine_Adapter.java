...
public class Cuisine_Adapter extends RecyclerView.Adapter<Cuisine_Adapter.ViewHolder> {
    ...
    public Cuisine_Adapter(ArrayList<Cuisine> cuisine_, Context context) {
        Cuisine = cuisine_;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.cuisine_card, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("cuisine", cuisineName);
